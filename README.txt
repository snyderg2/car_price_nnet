...
## New changes
python3 ./determineCarPrices.py -train_csv ./vehicles_large.csv -hu "[100, 100, 100, 100]" -out "[price]" -in "[year, manufacturer, model, condition, cylinders, fuel, odometer, title_status, transmission, drive, paint_color]"
python3 ./determineCarPrices.py -u "[2010, 1, 1, 1, 1, 1, 43000, 1, 1, 1, 1]"


python3 ./determineCarPrices.py -train_csv ./vehicles.csv -hu "[50, 50, 50, 50, 50, 50]" -out "[price]" -in "[year, manufacturer, model, condition, cylinders, fuel, odometer, title_status, transmission, drive, paint_color]"

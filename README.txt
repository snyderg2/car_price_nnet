...
python3 ./cleanAndSaveData.py -train_csv ./vehicles_large.csv -hu "[20, 20]" -out "[price]" -in "[manufacturer, model, condition, cylinders, fuel, odometer]"

#Otherwise only run (for four machine ws = 4 and r 0 to 3 and -ep for epoch) 
#in master machine
python3 ./distDetermineCarPrice.py -r 0 -ws 4 -ep 100000

# in second machine 
python3 ./distDetermineCarPrice.py -r 1 -ws 4 -ep 100000

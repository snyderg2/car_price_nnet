...
python3 ./cleanAndSaveData.py -train_csv ./vehicles_large.csv -out "[price]" -in "[year, manufacturer, model, condition, cylinders, fuel, odometer, title_status, transmission, drive, paint_color]"

#Otherwise only run (for four machine ws = 4 and r 0 to 3) ep = epoch
#in master machine
python3 ./distDetermineCarPrice.py -r 0 -ws 4 -ep 10000

# in second machine 
python3 ./distDetermineCarPrice.py -r 1 -ws 4 -ep 10000

# in 3rd machine 
python3 ./distDetermineCarPrice.py -r 2 -ws 4 -ep 10000
# in 4th machine 
python3 ./distDetermineCarPrice.py -r 3 -ws 4 -ep 10000

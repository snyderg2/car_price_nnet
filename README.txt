...
python3 ./determineCarPrices.py ./vehicles_medium.csv -v -hu "[20, 20]" -out "[price]" -in "[year, manufacturer, model, condition, cylinders, fuel, odometer, title_status, transmission, drive, paint_color]" -u "[2014, 2, 2, 2, 2, 1, 93000, 1, 2, 2, 0]"
